    ...
    return (
        <>
            ...
            <div className='flex flex-col lg:flex-row mx-10 lg:my-20 my-10'>
                ...
                <p className='text-justify text-[#333333] '>My name is Zane, and I'm the Co-Founder of <a href='https://techedge.pro' className='text-[#02B5DC]' target="_blank" rel="noreferrer">Tech Edge</a> a Full Stack Designer with more than two years of experience in the industry.
                ...
                <div className="lg:w-1/2 lg:mx-4 justify-center flex flex-col items-center text-center mt-10 mg:mt-0">
                     <AnimatedImage/>
                     <button className="mt-10 bg-[#02B5DC] text-white p-3 text-sm rounded-[20px] border-2 border-[#02B5DC] hover:bg-white hover:text-[#02B5DC] hover:font-bold duration-300">Contact Us</button>
                </div>
            </div>
            <Footer/>
        </>
