    ...
    return (
        <>
            ...
            <div className='flex flex-col lg:flex-row mx-10 lg:my-20 my-10'>
                ...
                <p className='text-justify text-[#333333] '>My name is Zane, and I'm the Co-Founder of <a href='https://techedge.pro' className='text-[#02B5DC]' target="_blank">Tech Edge</a> a Full Stack Designer with more than two years of experience in the industry.
